...
Panel {
  ...
  readonly property real warningThreshold: 0.50
  readonly property real criticalThreshold: 0.15

  readonly property color batteryIconColor: {
    if (root.batteryFraction < root.criticalThreshold) return "#a55555"
    if (root.batteryFraction < root.warningThreshold) return "#C9A554"
